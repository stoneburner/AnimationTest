...
public class TestStyleKit : NSObject {
    ...
    @objc dynamic public class func drawProgressBarDisplay(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 136, height: 22), resizing: ResizingBehavior = .aspectFit, progress: CGFloat = 0.704) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 136, height: 22), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 136, y: resizedFrame.height / 22)



        //// Variable Declarations
        let percentText = "\(Int(round(round(progress * 100))))" + "%"
        let progressWith: CGFloat = 124 * progress

        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 3, y: 3, width: 130, height: 15), cornerRadius: 3)
        UIColor.gray.setFill()
        rectanglePath.fill()


        //// Rectangle 3 Drawing
        let rectangle3Path = UIBezierPath(roundedRect: CGRect(x: 6, y: 6, width: 124, height: 9), cornerRadius: 1)
        UIColor.white.setFill()
        rectangle3Path.fill()


        //// Rectangle 2 Drawing
        let rectangle2Path = UIBezierPath(roundedRect: CGRect(x: 6, y: 6, width: progressWith, height: 9), cornerRadius: 1)
        TestStyleKit.color.setFill()
        rectangle2Path.fill()


        //// Text Drawing
        let textRect = CGRect(x: 3, y: 6, width: 130, height: 9)
    ...
    @objc dynamic public class func drawProgressCircleDisplay(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 140, height: 140), resizing: ResizingBehavior = .aspectFit, progress: CGFloat = 0.704) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
